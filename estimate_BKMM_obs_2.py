...
analysis_args = {
    'priors': [
     { 'parameter': 'B->K::alpha^fT_0@BSZ2015', 'min':  -1, 'max':   1,  'type': 'uniform'},
     { 'parameter': 'B->K::alpha^f+_1@BSZ2015', 'min':  -1, 'max':   1,  'type': 'uniform'},
     { 'parameter': 'B->K::alpha^fT_2@BSZ2015', 'min':  -1, 'max':   1,  'type': 'uniform'},
     { 'parameter': 'B->K::alpha^f+_0@BSZ2015', 'min':  -1, 'max':   1,  'type': 'uniform'},
     { 'parameter': 'B->K::alpha^f0_1@BSZ2015', 'min':  -1, 'max':   1,  'type': 'uniform'},
     { 'parameter': 'B->K::alpha^f0_2@BSZ2015', 'min':  -1, 'max':   1,  'type': 'uniform'},
     { 'parameter': 'B->K::alpha^fT_1@BSZ2015', 'min':  -1, 'max':   1,  'type': 'uniform'},
     { 'parameter': 'B->K::alpha^f+_2@BSZ2015', 'min':  -1, 'max':   1,  'type': 'uniform'},
    ],
    'likelihood': [
        'B->K::FormFactors[parametric,LCSRLattice]@GKvD:2018A',
        'B->D^(*)::FormFactors[parametric,LCSR]@GKvD:2018A',
    ]
}
...
for k in range(0,9):
	...
	#else :
	#	temp_tag = 'GP2004'
	options    = eos.Options({'l':'mu', 'q':'u', 'form-factors':'BSZ2015', 'model':'SM', 'tag':temp_tag, 'nonlocal-formfactors':'GvDV2020'})
